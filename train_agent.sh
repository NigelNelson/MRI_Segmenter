...
command="python -m segm.train_sweep --log-dir seg_tiny_mask_retrain --dataset ade20k --no-resume --backbone vit_tiny_patch16_384 --decoder mask_transformer --batch-size 16 --epochs 300 -lr 0.001"
